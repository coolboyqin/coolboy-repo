...
<head>
    ...
    <script type="text/javascript">
        ...
        particleImage.src = '${pageContext.request.contextPath}/static/images/ParticleSmoke.png';
                        ...
                        $.ajax({
                            ...
                            success: function (result) {
                                if ("success" == result) {
                                    swal({
                                        title: "获得" + txt + "红包",
                                        imageUrl: "${pageContext.request.contextPath}/static/images/gx.png"
                                    });
...
<body>
<div bgcolor="#eae0d9" id="body" onLoad="init()">
    <div class="couten" style="position:fixed; width:100%; margin:0 auto; text-align:center; padding-top:5%">
        <div class="turntable-bg">
            ...
            <div class="pointer"><img src="${pageContext.request.contextPath}/static/images/pointer.png" alt="pointer"/>
            </div>
            <div class="rotate"><img id="rotate" src="${pageContext.request.contextPath}/static/images/turntable.png"
                                     alt="turntable"/ >
            </div>
        </div>
    </div>
...
<div id="records" style="margin: 20px 0 30px 0">
    <ul>
        <c:forEach var="r" items="${result}">
         <li>中奖纪录-- <span >${r.prize}</span></li>
        </c:forEach>
    </ul>
</div>
